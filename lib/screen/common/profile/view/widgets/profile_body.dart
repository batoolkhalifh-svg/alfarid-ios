  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocProvider<ProfileCubit>(
          ...
          child: BlocBuilder<ProfileCubit, BaseStates>(builder: (context, state) {
              ...
              child: CacheHelper.getData(key: AppCached.token) == null
                  ? Container(
                      ...
                      decoration: BoxDecoration(
                          color: Colors.white,
                          borderRadius:
                              BorderRadius.only(topRight: Radius.circular(AppRadius.r15), topLeft: Radius.circular(AppRadius.r15))),
                          ...
                          child: SingleChildScrollView(
                            child: Column(children: [
                              ...
                              CustomProfileRow(
                                ...
                                img: AppImages.notificationProfile,
                                onTap: () {
                              ...
                              if (CacheHelper.getData(key: AppCached.role) == AppCached.teacher) ...[
                                ...
                                CacheHelper.getData(key: AppCached.isApple) == true
                                    ? const SizedBox.shrink()
                                    : CustomProfileRow(
                                        text: LocaleKeys.managePackage.tr(),
                                        img: AppImages.package,
                                        onTap: () {
                                ...
                                CacheHelper.getData(key: AppCached.isApple) == true
                                    ? const SizedBox.shrink()
                                    : CustomProfileRow(
                                        text: LocaleKeys.subscribePackages.tr(),
                                        img: AppImages.package,
                                        onTap: () {
                              ...
                              CacheHelper.getData(key: AppCached.isApple) == true
                                  ...
                                  : CustomProfileRow(
                                      ...
                                      onTap: () {
                                        Share.share(
                                          'جرّب تطبيقنا الرائع من هنا:\n\n📱 Android: https://play.google.com/store/apps/details?id=com.teacher.alfarid.app\n🍎 iOS: https://apps.apple.com/us/app/alfarid/id6743389584',
                                          subject: 'شارك تطبيقنا مع أصدقائك!',
                                        );
                                      },
                                    ),
                              state is BaseStatesLoadingState
                            ...
                            CircleAvatar(
                              ...
                              child: CircleAvatar(
                                ...
                                backgroundImage: cubit.imagePicked != null
                                    ? FileImage(File(cubit.imagePicked!))
                                    : NetworkImage(CacheHelper.getData(key: AppCached.image)) as ImageProvider,
