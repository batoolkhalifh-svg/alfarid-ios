  ...
  Widget build(BuildContext context) {
    return BlocProvider<RegisterCubit>(
        ...
        child: BlocBuilder<RegisterCubit, BaseStates>(builder: (context, state) {
          ...
          return CustomAuthBg(
              widget: Padding(
            padding: EdgeInsets.only(left: width * 0.08, right: width * 0.08, top: width * 0.18),
            child: Column(
              children: [
                ...
                CustomTextField(
                  ...
                  ctrl: TextEditingController.fromValue(
                    TextEditingValue(
                      text: cubit.selectedClassroomNames.join(', '),
                    ),
                  ),
                  onTap: () {
                ...
                if (state is BaseStatesLoadingState2)
                  Padding(
                ...
                CacheHelper.getData(key: AppCached.role) == AppCached.student
                    ...
                    : state is BaseStatesLoadingState2
                        ...
                        : CustomTextField(
                            ...
                            ctrl: TextEditingController.fromValue(
                              TextEditingValue(
                                text: cubit.selectedSubjectsNames.join(', '),
                              ),
                            ),
                            onTap: () {
                              showModalBottomSheet(
