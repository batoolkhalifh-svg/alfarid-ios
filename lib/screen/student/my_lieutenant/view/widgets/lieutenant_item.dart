...
class LieutenantItem extends StatelessWidget {
  ...
  const LieutenantItem({super.key, required this.img, required this.name, this.price,required this.classRoom, this.file, this.onTapCart, required this.subject, this.onTapExam});
          ...
          children: [
            ...
            Row(
              children: [
                SizedBox(
                    width:width*0.3,
                    child: Text(subject, style: Styles.textStyle14.copyWith(color: AppColors.mainColor2,fontFamily: AppFonts.almaraiRegular),maxLines: 2,overflow: TextOverflow.ellipsis,)),
              ],
            ),
            Row(
              children: [
                SizedBox(
                    width:width*0.3,
                    child: Text(classRoom, style: Styles.textStyle14.copyWith(color: AppColors.mainColor2,fontFamily: AppFonts.almaraiRegular),maxLines: 1,overflow: TextOverflow.ellipsis,)),
                const Spacer(),
                CacheHelper.getData(key: AppCached.isApple)==true?
                const SizedBox.shrink():
            ...
            if(file!=null)...[
              ...
              CustomButton(text: LocaleKeys.startTest.tr(), onPressed: onTapExam,widthBtn: width*0.85,hit: height * 0.045,)
            ]
