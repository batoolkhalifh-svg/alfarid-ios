      ...
      return Scaffold(
          body:SafeArea(
              child: Column(
                  ...
                  children: [
                    CustomArrow(text: LocaleKeys.importantCourses.tr(),),
                    Padding(
                        padding: EdgeInsets.symmetric(horizontal: width * 0.07, vertical: width * 0.03),
                        child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              const CustomTitleCourseList(withOutPadding: true,),
                              SizedBox(height: height*0.008),
                              state is LoadingHomeState2? Padding(
                                  ...
                                  controller: controller,
                                    ...
                                    itemBuilder: (context, index){
                                      return  CustomCourseItem(
                                        ...
                                        onTap: (){ navigateTo(widget: CourseDetailsScreen(id: cubit.data[index].id!,));},
                                        isSaves: cubit.data[index].isFavourite,
                                        onTapSave: (){cubit.toggleSaved(id: cubit.data[index].id!,index: index);},);
