          ...
          builder: (context,state) {
            ...
            return Column(
              children: [
                  ...
                  child: Row(
                    ...
                    Text("${LocaleKeys.welcome.tr()} ${CacheHelper.getData(key: AppCached.name)?? ''}",style: Styles.textStyle14.copyWith(color: AppColors.mainColorText),),
                       ...
                       GestureDetector(
                        ...
                        child: Image.asset(AppImages.cart,width: width*0.11,),
                      ),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(LocaleKeys.searchAbout.tr(),style: Styles.textStyle14.copyWith(color: AppColors.grayColor2,fontFamily: AppFonts.almaraiRegular),),
                ...
                CarouselSlider(
                  items: List.generate(cubit.bannersModel!.data!.length, (index) => Padding(
                    padding: EdgeInsets.symmetric(horizontal: width*.045),
                    child:CustomNetworkImg(width: width,fit: BoxFit.fill, img: cubit.bannersModel!.data![index].image!,)
                  ),),
