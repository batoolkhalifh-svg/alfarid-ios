              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    SizedBox(
                        width: width*0.33,
                        child: Text(cubit.data[index].name.toString(),style: Styles.textStyle14.copyWith(color: AppColors.mainColor2),maxLines: 2,overflow: TextOverflow.ellipsis,)),
                    GestureDetector(
                        onTap: (){cubit.toggleSaved(id: cubit.data[index].id!,index: index);},
                        child: SvgPicture.asset(cubit.data[index].isFavourite==true? AppImages.save:AppImages.unSave,width: width*0.05))
                  ],
                ),
              ),
              Padding(
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    const Icon(Icons.person,color: AppColors.mainColor2,size: 18,),
                  ],
                ),
              ),
