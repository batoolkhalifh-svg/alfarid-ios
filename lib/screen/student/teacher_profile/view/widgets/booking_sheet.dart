...
class BookingSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    cubit.classroomType = classroomType;
    /// جلب السعر من API أول ما تفتح الشاشة
    if (classroomType != null && cubit.basePrice == null) {
      cubit.getPriceFromAPI(schoolType: classroomType!);
    }
        ...
        builder: (context, state) {
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                Center(
                    child: Text(LocaleKeys.bookingPrivateSession.tr(),
                        style:
                    ...
                    cubit.availableDays.length,
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            border: Border.all(
                                color: cubit.selectedDays
                                    .contains(cubit.availableDays[index])
                                    ? AppColors.mainColor
                                    : Colors.grey)),
                        child: Text(
                ...
                Row(
                  children: [
                    Expanded(
                        child: Text(
                            '${LocaleKeys.from.tr()}: ${slots.isNotEmpty ? slots.first : '-'}')),
                    Expanded(
                        child: Text(
                            '${LocaleKeys.to.tr()}: ${slots.isNotEmpty ? slots.last : '-'}')),
                  ],
                ),
                ...
                Text(LocaleKeys.noteMustBeInRange.tr(),
