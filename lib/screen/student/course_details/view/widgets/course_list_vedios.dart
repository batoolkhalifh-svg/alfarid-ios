          ...
          return Column(
            children: [
              Row(
                children: [
                  Text(
                    cubit.courseDetailsModel!.data!.sections![index1].name.toString(),
                  ...
                  Text(
                    cubit.courseDetailsModel!.data!.sections![index1].totalDuration.toString(),
              ...
              ListView.separated(
                  ...
                  itemBuilder: (context, index) => GestureDetector(
                        onTap: () {
                          if (cubit.courseDetailsModel!.data!.isSubscribed == true ||
                        ...
                        child: Container(
                          decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(AppRadius.r15)),
                          padding: EdgeInsets.symmetric(horizontal: width * 0.035, vertical: width * 0.04),
                          child: Row(
                            children: [
                              Container(
                                ...
                                child: Text(
                                  "${index + 1}",
                                  style: TextStyle(color: Colors.white, fontFamily: AppFonts.jost, fontSize: AppFonts.t10),
                                ),
                              ),
                              SizedBox(
                                width: width * 0.02,
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      cubit.courseDetailsModel!.data!.sections![index1].lessons![index].name.toString(),
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(width: width * 0.01),
                                        Text(
                                          cubit.courseDetailsModel!.data!.sections![index1].lessons![index].duration.toString(),
                                          style: Styles.textStyle10.copyWith(color: const Color(0xffCBCBCB)),
                                        )
                                      ],
                                    ),
                                  ],
                              ...
                              const Spacer(),
                              cubit.courseDetailsModel!.data!.sections![index1].lessons![index].isFree == true ||
                                      cubit.courseDetailsModel!.data!.isSubscribed!
                                  ? SvgPicture.asset(AppImages.play)
                                  : SvgPicture.asset(
                                      AppImages.editPass,
