            ...
            child: BlocBuilder<CourseDetailsCubit, CourseDetailsStates>(builder: (context, state) {
              ...
              return SafeArea(
                child: Column(
                  children: [
                    CustomArrow(
                      text: LocaleKeys.courseDetails.tr(),
                    ),
                    state is CourseDetailsLoadingState
                        ? Padding(
                        ...
                        : state is CourseDetailsErrorState
                            ? CustomError(
                                title: state.msg,
                                onPressed: () {
                                  cubit.getCourseDetails(id: id);
                                })
                            : Expanded(
                                child: Padding(
                                  ...
                                  child: SingleChildScrollView(
                                    child: Column(
                                      children: [
                                        state is CourseDetailsSChangeVideoState
                                            ? Padding(
                                                padding: EdgeInsets.symmetric(vertical: height * .08),
                                                child: const CustomLoading(),
                                              )
                                            : CourseDetailsVideo(
                                                path: cubit.courseDetailsModel!.data!.sections![cubit.currentSection]
                                                    .lessons![cubit.currentLesson].video
                                                    .toString(),
                                                cubit: cubit,
                                                lessonId: cubit.courseDetailsModel!.data!.sections![cubit.currentSection]
                                                    .lessons![cubit.currentLesson].id!),
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: Text(cubit.courseDetailsModel!.data!.name.toString(),
                                                ...
                                                children: [
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        cubit.courseDetailsModel!.data!.duration.toString(),
                                                        style: Styles.textStyle10.copyWith(color: AppColors.blackColor),
                                                      ),
                                                      Text(
                                                        " | ",
                                                        style: Styles.textStyle20.copyWith(color: AppColors.blackColor),
                                                      ),
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Text(
                                                          cubit.courseDetailsModel!.data!.totalLessons.toString(),
                                                          style: Styles.textStyle10.copyWith(color: AppColors.blackColor),
                                                        ),
                                                      ),
                                                      SizedBox(width: width * 0.01),
                                                      ...
                                                      ? CustomButton(
                                                          ...
                                                          onPressed: () {
                                                            cubit.courseDetailsModel!.data!.isCompleted == false
                                                                ? showToast(
                                                                    text: LocaleKeys.youShouldCompleteCourse.tr(), state: ToastStates.error)
                                                                : cubit.courseDetailsModel!.data!.isExamToken == true
                                                                    ? showToast(
                                                                        text: LocaleKeys.youPassedTheExam.tr(), state: ToastStates.error)
                                                                    : navigateTo(
                                                                        widget: ExamScreen(
                                                          ...
                                                          : CustomButton(
                                                              ...
                                                              onPressed: () {
                                                                CacheHelper.getData(key: AppCached.token) == null
                                                                    ...
                                                                    : cubit.subScribe(id: cubit.courseDetailsModel!.data!.id!.toInt());
                                                              },
                                                              widthBtn: width * 0.85)
                                            ],
                                          ),
